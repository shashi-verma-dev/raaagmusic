...
@section('title', 'Create Your Own Song | RaaagMusic - Personalized Songs for Every Emotion')
@section('description', 'Turn your emotions into music! Fill out the form to create a personalized song for any occasion—birthday, anniversary, wedding, or just because. Crafted uniquely for your story.')
@section('keywords', 'custom song, personalized music, create your own song, song form, gift a song, emotional songs, unique gift idea, RaaagMusic')
        ...
        <div class="container">
            <div class="row align-items-center text-center text-md-start">
                ...
                <div class="col-12 col-md-2 mb-4 mb-md-0 d-flex justify-content-center p-4">
                    <img src="{{ asset('public/frontend/assets/lotti_animations/Music_Player.gif') }}" class="img-fluid"
            ...
            <div class="row g-5 padding_manage_create_song">
                ...
                <div class="col-xl-7">
                    <div class="create_song_page-form-section">
                        ...
                        <form class="mx-auto" style="max-width: 800px;" id="personalizedSongForm">
                            ...
                            <!-- 5. Duration - conditional by segment -->
                            <div class="mb-4" id="durationSection">
                                <label class="form-label">
                                    <i class="bi bi-hourglass-split text-secondary"></i> Choose Song Duration <span
                                        class="text-danger">*</span>
                                </label>
                                <input type="hidden" id="duration_input" name="duration" value="">
                                <div id="durationChips" class="chip-group"></div>
                            </div>

                            <!-- 6. Delivery Timeline -->
                            <div class="mb-4">
                                <label class="form-label"><i class="bi bi-clock-history text-dark"></i> Choose Song
                                    Delivery Timeline <span class="text-danger">*</span></label>
                                <input type="hidden" id="timeline_input" name="timeline" value="24 Hours">
                                <div class="chip-group" id="timelineChips"></div>
                            </div>
                            ...
                            <!-- Form submission button and bottom note -->
                        ...
                        <script>
                            const segmentDurations = {
                                "Pocket-Friendly-Ai": [{
                                        label: "2 - 3 Minutes Default",
                                        value: "2 - 3 Minutes 399",
                                        default: true
                                    },
                                    {
                                        label: "3 - 4 Minutes (Rs 100 EXTRA)",
                                        value: "3 - 4 Minutes 499"
                                    }
                                ],
                                "Ai-Fusion": [{
                                        label: "1 - 2 Minutes Default",
                                        value: "1 - 2 Minutes 799",
                                        default: true
                                    },
                                    {
                                        label: "2 - 3 Minutes (Rs 149 EXTRA)",
                                        value: "2 - 3 Minutes 948"
                                    },
                                    {
                                        label: "3 - 4 Minutes (Rs 249 EXTRA)",
                                        value: "3 - 4 Minutes 1048"
                                    }
                                ],
                                "Full-Artist": [{
                                        label: "1 - 2 Minutes Default",
                                        value: "1 - 2 Minutes 1499",
                                        default: true
                                    },
                                    {
                                        label: "2 - 3 Minutes (Rs 149 EXTRA)",
                                        value: "2 - 3 Minutes 1648"
                                    },
                                    {
                                        label: "3 - 4 Minutes (Rs 249 EXTRA)",
                                        value: "3 - 4 Minutes 1748"
                                    }
                                ]
                            };
                            ...
                            function updateChips(groupName, options, defaultValue) {
                                const group = document.getElementById(groupName + "Chips");
                                const input = document.getElementById(groupName + "_input");
                                group.innerHTML = "";

                                options.forEach(opt => {
                                    const chip = document.createElement("div");
                                    chip.className = "chip" + (opt.default ? " active" : "");
                                    chip.dataset.group = groupName;
                                    chip.dataset.value = opt.value;
                                    chip.innerText = opt.label;
                                    chip.onclick = () => activateChip(groupName, chip);
                                    group.appendChild(chip);
                                    if (opt.default) input.value = opt.value;
                                });
                            }

                            function activateChip(group, chip) {
                                const input = document.getElementById(group + "_input");
                                document.querySelectorAll(`.chip[data-group="${group}"]`).forEach(c => c.classList.remove("active"));
                                chip.classList.add("active");
                                input.value = chip.dataset.value;

                                // Show extra input if occasion is Other
                                if (group === "occasion") {
                                    document.getElementById("other_occasion_input").style.display = chip.dataset.value === "Other" ? "block" :
                                        "none";
                                }
                            }

                            document.addEventListener("DOMContentLoaded", function() {
                                const defaultSegment = "Full-Artist";
                                updateChips("duration", segmentDurations[defaultSegment]);
                                updateChips("timeline", timelinePrices[defaultSegment]);

                                document.querySelectorAll('[data-group="segment"]').forEach(chip => {
                                    chip.addEventListener("click", () => {
                                        const selectedSegment = chip.dataset.value;
                                        updateChips("duration", segmentDurations[selectedSegment]);
                                        updateChips("timeline", timelinePrices[selectedSegment]);
                                    });
                                });
                            });
                        </script>
                    ...
                    <div id="create_song_page-carousel" class="carousel slide mb-4" data-bs-ride="carousel"
                        ...
                        <div class="carousel-inner rounded">
                            <div class="carousel-item active">
                                <img src="{{ asset('public/frontend\assets\images\index_page_image\guitar-hands.jpg') }}"
                            ...
                            <div class="carousel-item ">
                                <img src="{{ asset('public/frontend\assets\images\index_page_image\couple-dancing.jpg') }}"
                                    class="d-block w-100 rounded" alt="...">
                                <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded p-2">
                                    <h5>Crafted With Heart</h5>
                                    <p>Every song is carefully composed and performed by talented artists who understand
